...
public class RedAllianceQuals extends NextFTCOpMode {
    ...
    public void onInit() {
        ...
        Pose startPose = new Pose(53.985, 40.005, Math.toRadians(0)).plus(new Pose(72, 72, 0));
    ...
    private Command auto() {
        ...
        return new SequentialGroup(
                ...
                RobotNF.INSTANCE.shootBalls(0.52),
                ...
                new ParallelGroup(
                        ...
                        cruiseShootBalls(
                                ...
                                new SequentialGroup(
                                        ShooterNF.INSTANCE.setVel(paths.fourthGateReturn.endPose(), 15),
